...
style={{width:400, height:200 , borderRadius: 30 ,alignSelf:'center'}} />
     ...
     onPress={() => navigation.navigate('check61')} >
           <Text style={styles.txt}> Enlarged fetus organs test</Text>
        </TouchableOpacity>       
        </View>
        ...
        <TouchableOpacity style={styles.num}
          ...
          <View style={styles.flexview}>
          <TouchableOpacity
           onPress={() => navigation.navigate('month6')} >
...
style={{width:400, height:200 , borderRadius: 30 ,alignSelf:'center'}} />
        ...
        <TouchableOpacity style={styles.num}
     onPress={() => navigation.navigate('check61')} >
           <Text style={styles.txt}> اختبار أعضاء الجنين المتضخمة</Text>
        </TouchableOpacity>       
        </View>
