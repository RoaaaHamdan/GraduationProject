...
What do you know about childbirth?
      ...
      <View style={styles.flexview}>
        ...
        >
          <Text style={styles.txt1}>Question 5/5 </Text>
</TouchableOpacity>
</View>
...
Can you be awake during a cesarean?
         </Text>
            </View>
...
Your doctor will give you a needle to numb you from the chest down. The entire process takes 45 minutes to an hour. It won't hurt. You will be able to hear and see your baby right after birth.
      </Text>
              </View>
...
ماذا تعرفين عن الولادة؟
      ...
      <View style={styles.flexview}>
           <TouchableOpacity style={styles.num1}
        >
          <Text style={styles.txt1}>السؤال 5/5 </Text>
</TouchableOpacity>
</View>
...
هل يمكنك أن تكوني مستيقظة أثناء عملية الولادة قيصرية؟
         </Text>
            </View>
...
سيعطيك طبيبك إبرة لتخديرك من صدرك إلى أسفل. تستغرق العملية بأكملها من 45 دقيقة إلى ساعة. لاتخافي. ستكونين قادرة على سماع ورؤية طفلك فور ولادته.
      </Text>
              </View>
