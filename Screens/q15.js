...
export default class  q15 extends Component {
  constructor(props){
    super(props);
  this.state={
    flag:'none',
...
Should you consult your doctor about exercising?
</Text>
            </View>
...
A doctor should be consulted about good exercises and exercises that cause harm to the fetus.
If there are no problems, do light sports, such as swimming or brisk walking, and avoid strenuous sports.
</Text>
              </View>
...
المسموح والممنوع أثناء الحمل
      ...
      <View style={styles.flexview}>
           <TouchableOpacity style={styles.num1}
        >
          <Text style={styles.txt1}>السؤال 5/6 </Text>
</TouchableOpacity>
</View>
...
هل يجب أن تستشيري طبيبك بخصوص ممارسة الرياضة؟
</Text>
            </View>
...
<Text style={{display:this.state.flag1, 
         ...
         يجب استشارة الطبيب بخصوص التمارين الجيدة والتمارين التي تضر بالجنين.
         إذا لم تكن هناك مشاكل ، قومي بممارسة الرياضات الخفيفة ، مثل السباحة أو المشي السريع ، وتجنب الرياضات الشاقة.
         </Text>
              </View>
