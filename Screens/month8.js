...
export default class  month8  extends Component{
  constructor(props){
    super(props);
    this.state={
      display1:'flex',
      ...
      return (
        <SafeAreaView style={{backgroundColor:'pink', flex:1}}>
          ...
          >
            ...
            <View>
           <Image source={require('../assets/month8.jpg')}
  style={{width:400, height:220, borderRadius:30, marginTop:20 }} />
       ...
       onPress={() =>  this.props.navigation.navigate('baby8')} >
             <Text style={styles.txt}> Your fetus</Text>
               ...
               <View style={styles.flexview}> 
              <TouchableOpacity style={styles.num}
       onPress={() =>  this.props.navigation.navigate('mother8')} >
