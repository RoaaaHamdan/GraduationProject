...
export default class  q71 extends Component {
  constructor(props){
    super(props);
  this.state={
    flag:'none',
...
The first tooth of the baby may appear usually in the age between 6-12 months?
         </Text>
            </View>
...
In normal the teeth appearance in the age between 6_12 months, but some children may have their first tooth before or after.
        </Text>
              </View>
...
In normal the teeth appearance in the age between 6_12 months, but some children may have their first tooth before or after.
          ...
          onPress={() => this.props.navigation.navigate('q72')} >
          <Text style={{
              color: 'black',
              fontSize: 24,
              fontFamily: 'Amiri-BoldItalic',
...
قد يظهر السن الأول للطفل عادة في عمر ما بين 6-12 شهرًا؟
         </Text>
            </View>
...
الوضع الطبيعي هو ظهور الأسنان في عمر ما بين 6_12 شهرًا ، لكن هذا لا يتعارض مع حقيقة أن بعض الأطفال قد تظهر أسنانهم الأولى قبل أو بعد.
        </Text>
              </View>
