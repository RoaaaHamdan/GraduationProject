...
What do you know about childbirth?
      ...
      <View style={styles.flexview}>
          ...
          <Text style={styles.txt1}>Question 2/5 </Text>
</TouchableOpacity>
</View>
...
Can you eat freely during labor?
         </Text>
            </View>
...
You can only drink water, juice or even coffee during labor. Eating food is forbidden, for fear that a pregnant woman will need a sudden cesarean delivery.
</Text>
              </View>
...
ماذا تعرفين عن الولادة؟
      ...
      <View style={styles.flexview}>
           <TouchableOpacity style={styles.num1} >
          <Text style={styles.txt1}>السؤال 2/5 </Text>
</TouchableOpacity>
</View>
...
هل يمكنك الأكل بحرية أثناء المخاض؟
         </Text>
            </View>
...
يمكنك فقط شرب الماء أو العصير أو حتى القهوة أثناء المخاض. الأكل ممنوع خوفا من حاجة الحامل لولادة قيصرية مفاجئة.
</Text>
              </View>
