...
style={{width:400, height:200 , borderRadius: 30 ,alignSelf:'center'}} />
     ...
     onPress={() => navigation.navigate('check31')} >
           <Text style={styles.txt}> CBC test</Text>
        </TouchableOpacity>       
 
            <TouchableOpacity style={styles.num}
       onPress={() => navigation.navigate('check32')} >
          <Text style={styles.txt}>Chorionic villi test </Text>
        </TouchableOpacity>
        </View>

        <View style={styles.flexview}>
          <TouchableOpacity style={styles.num}
         onPress={() => navigation.navigate('check33')} >
          <Text style={styles.txt}> First trimester of pregnancy test</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.num}
          ...
          <View style={styles.flexview}>
          <TouchableOpacity
           onPress={() => navigation.navigate('month3')} >
...
style={{width:400, height:200 , borderRadius: 30 ,alignSelf:'center'}} />
        ...
        <TouchableOpacity style={styles.num}
     onPress={() => navigation.navigate('check31')} >
           <Text style={styles.txt}> اختبار CBC</Text>
        </TouchableOpacity>       
 
            <TouchableOpacity style={styles.num}
       onPress={() => navigation.navigate('check32')} >
          <Text style={styles.txt}>اختبار الزغابات المشيمية</Text>
        </TouchableOpacity>
        </View>
        ...
        <View style={styles.flexview}>
          <TouchableOpacity style={styles.num}
         onPress={() => navigation.navigate('check33')} >
          <Text style={styles.txt}> الثلث الأول من اختبار الحمل</Text>
        </TouchableOpacity>
