...
export default class  q42 extends Component {
  constructor(props){
    super(props);
  this.state={
    flag:'none',
...
Can the child's temperature be taken immediately after bathing?
         </Text>
            </View>
...
This is possible, but it is imprecise because the warmth of the water in the bathroom affects the accuracy of the measurement.
      </Text>
              </View>
...
<View style={styles.flexview}>
          ...
          onPress={() => this.props.navigation.navigate('q43')} >
          <Text style={{
              color: 'black',
              fontSize: 20,
              fontFamily: 'Amiri-BoldItalic',
...
هل يمكن قياس درجة حرارة الطفل بعد الاستحمام مباشرة؟
         </Text>
            </View>
...
هذا ممكن ، لكنه غير دقيق لأن دفء الماء في الحمام يؤثر على دقة القياس.
      </Text>
              </View>
