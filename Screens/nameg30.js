    ...
    const [x, setx] = React.useState('');
      const cal = () => { 
        if (x === '') {
          ...
          if (x == 1) {
            navigation.navigate('nameg31')
          }
          else if (x == 2) {
            navigation.navigate('nameg32')
          }
         else if (x == 3) {
            navigation.navigate('nameg33')
          }
          else if (x == 4) {
            navigation.navigate('nameg34')
        }
          else if (x == 5) {
            navigation.navigate('nameg35')
          }
          else if (x == 6) {
            navigation.navigate('nameg36')
          }
        }
    }
    return (
...
يبدأ بحرف:
          ...
          <RadioButton
              ...
              <Text style={styles.txt}>شين</Text>
