...
export default class showReq extends Component {
  constructor(props) {
    super(props);
    this.data = [];
    this.state = {
...
<View style={{
   ...
   <View style={{
            ...
            Communications.email(
              ...
              null,
              null,
              'About Your Registration Request to ALLO DOCTOR app',
              'your Pass Code is =>'+this.state.passCode+' and Your user name is =>'+this.state.userName,
            )
          }
                >
                   <Text
