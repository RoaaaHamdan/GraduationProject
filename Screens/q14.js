...
export default class  q14 extends Component {
  constructor(props){
    super(props);
  this.state={
    flag:'none',
...
Allowed and prohibited during pregnancy
</Text>
      </View>
...
Can you take over-the-counter medications during pregnancy?
</Text>
            </View>
...
Do not take medicines unless approved by the doctor. Medicines that are safe before pregnancy may cause harm to the fetus during pregnancy.
</Text>
              </View>
...
المسموح والممنوع أثناء الحمل
      ...
      <View style={styles.flexview}>
           <TouchableOpacity style={styles.num1}
        >
          <Text style={styles.txt1}>السؤال 4/6 </Text>
</TouchableOpacity>
</View>
...
هل يمكنك تناول الأدوية التي لا تستلزم وصفة طبية أثناء الحمل؟
</Text>
            </View>
...
لا تتناولي الأدوية إلا بموافقة الطبيب. الأدوية الآمنة قبل الحمل قد تسبب ضررًا للجنين أثناء الحمل.
</Text>
              </View>
