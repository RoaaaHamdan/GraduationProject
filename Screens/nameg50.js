    ...
    const [x, setx] = React.useState('');
      const cal = () => { 
        if (x === '') {
          ...
          if (x == 1) {
            navigation.navigate('nameg51')
          }
          else if (x == 2) {
            navigation.navigate('nameg52')
          }
         else if (x == 3) {
            navigation.navigate('nameg53')
          }
          else if (x == 4) {
            navigation.navigate('nameg54')
        }
          else if (x == 5) {
           navigation.navigate('nameg55')
          }
        }
    }
    return (
...
يبدأ بحرف:
          ...
          <RadioButton
              ...
              <Text style={styles.txt}>تاء</Text>
