...
export default class Memorylevel3 extends Component {
  constructor(props){
    super(props);
    this.state={
      setc:0,
   ...
   propse = (val, val1) => {
    ...
    this.setState({t:'flex'})
     ...
     this.setState({t1:'flex'})
      ...
      //sety('flex')
      this.setState({t13:'flex'})
    }
     else if (val1 == 't134'){ 
    this.setState({t134:'flex'})
    }
    else if (val1 == 'm11'){ 
    this.setState({m11:'flex'})
    }
    else if (val1 == 'm12'){ 
     this.setState({m12:'flex'})
    }
    if (this.state.count == 0) {
      ...
      this.setState({xx:this.state.xx+1})
        ...
        else  if(val1 == 't13'||val1 == 't134' ){
          this.setState({dis15:true,dis16:true})
        }

        else  if(val1 == 'm11'||val1 == 'm12' ){
          this.setState({dis14:true,dis13:true})
        }
                  alert('go ahead!');
...
//xx=0;
          ...
          m11:'none',m12:'none',t13:'none',t134:'none',
          ...
          ,dis12:false,dis13:false,dis14:false
          ,dis15:false,dis16:false})
