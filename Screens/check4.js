...
style={{width:400, height:200 , borderRadius: 30 ,alignSelf:'center'}} />
     ...
     onPress={() => navigation.navigate('check41')} >
           <Text style={styles.txt}>Fetal organs test</Text>
        </TouchableOpacity>       

            <TouchableOpacity style={styles.num}
       onPress={() => navigation.navigate('check42')} >
        ...
        <TouchableOpacity style={styles.num}
          ...
          <View style={styles.flexview}>
          <TouchableOpacity
           onPress={() => navigation.navigate('month4')} >
...
style={{width:400, height:200 , borderRadius: 30 ,alignSelf:'center'}} />
        ...
        <TouchableOpacity style={styles.num}
     onPress={() => navigation.navigate('check41')} >
           <Text style={styles.txt}>اختبار أعضاء الجنين</Text>
        </TouchableOpacity>       

            <TouchableOpacity style={styles.num}
       onPress={() => navigation.navigate('check42')} >
          <Text style={styles.txt}>اختبار ألبومين الجنين </Text>
        </TouchableOpacity>
        </View>
